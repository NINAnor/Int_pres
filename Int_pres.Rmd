...
- Billig å utvikle (alternativ er It-personnell)
...
<br>
<br>
```{r git_flow, echo=F, out.width=800, fig.cap="Git arbeider med greiner som kan sys sammen"}
include_graphics("./img/git_flow.jpg")
```
<br>
<br>
